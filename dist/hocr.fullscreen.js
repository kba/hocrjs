...
var _hocrViewer = __webpack_require__(6);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js?sourcemap=true!../node_modules/sass-loader/lib/loader.js?sourcemap-=true!./normalize.scss", function() {
			var newContent = require("!!../node_modules/css-loader/index.js?sourcemap=true!../node_modules/sass-loader/lib/loader.js?sourcemap-=true!./normalize.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../css-loader/index.js?sourcemap=true!../sass-loader/lib/loader.js?sourcemap-=true!./normalize.css", function() {
			var newContent = require("!!../css-loader/index.js?sourcemap=true!../sass-loader/lib/loader.js?sourcemap-=true!./normalize.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
